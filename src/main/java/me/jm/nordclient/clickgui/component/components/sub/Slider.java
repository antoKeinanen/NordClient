...
public class Slider extends Component {
	...
	public void renderComponent() {
		// background
		Gui.drawRect(parent.parent.getX() + 2, parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 12, ColorHelper.ToOpacityMode(ColorHelper.BGR02));
		 final int drag = (int)(this.set.getValDouble() / this.set.getMax() * this.parent.parent.getWidth());
		 // slider
		Gui.drawRect(parent.parent.getX() + 2, parent.parent.getY() + offset, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12, ColorHelper.ToOpacityMode(ColorHelper.FORST02));
		...
		//text
		Minecraft.getMinecraft().fontRenderer.drawString(this.set.getName() + ": " + this.set.getValDouble() , (parent.parent.getX()* 2 + 15), (parent.parent.getY() + offset + 2) * 2 + 5, ColorHelper.WHITE02);
		GL11.glPopMatrix();
	}
